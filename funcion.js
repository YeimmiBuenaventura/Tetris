...
function square()
{
    ...
    if(x > canvas.width - 10 || x_1 > canvas.width - 10){ //Si x o x_1(eje horizontal) es mayor que el ancho del canvas -10(Se adjudica este valor para simular el espacio de la figura)
      [x=canvas.width-20, x_1=canvas.width-10, x_2=canvas.width-10 ]; //Esto nos permite que el fotograma quede estatico al llegar al final del ancho del canvas
    }
    if(y > canvas.height - 10 || y_1 > canvas.height - 30 || y_2 > canvas.height - 10){//Si y o y_1 o y_2 (eje vertical) se pasa del alto del canvas respectivamente (Se adjudica este valor para simular el espacio de la figura) la figura se detendra
